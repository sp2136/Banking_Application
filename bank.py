...
import subprocess  # Import subprocess module to run the script
import sys  # Import sys module to access the Python executable path
...
class BankingApp:
    def __init__(self, root):
        ...
        self.account_info_label = tk.Label(root, text="")
...
if __name__ == "__main__":
    ...
    subprocess.run([python_executable, "mac_secure_state.py"])
